...
function compileContracts() {
  ...
  execSync(`yarn buidler compile`, { encoding: 'utf-8' });
  execSync(`yarn buidler compile --config ${buidlerConfigSol5}`, { encoding: 'utf-8'});
  execSync(`yarn buidler compile --config ${buidlerConfigSol4}`, { encoding: 'utf-8'});
}
