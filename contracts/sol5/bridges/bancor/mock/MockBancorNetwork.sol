...
contract MockBancorNetwork is IBancorNetwork, Utils4 {
    ...
    constructor(IERC20 _bancorBNT, IERC20[] memory _ethToBntPath, IERC20[] memory _bntToEthPath)
        public
    {
    ...
    function setNewEthBntPath(IERC20[] memory _ethToBntPath, IERC20[] memory _bntToEthPath)
        public
    {
        ethToBntPath = _ethToBntPath;
        bntToEthPath = _bntToEthPath;
