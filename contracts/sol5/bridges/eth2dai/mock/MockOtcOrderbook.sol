...
contract MockOtcOrderbook {
    ...
    function setSellOffer(uint id, ERC20 offerSellGem, uint payAmt, ERC20 offerBuyGem, uint buyAmt)
        public
    {
        sellOffers.push(OfferInfo(id, payAmt, offerSellGem, buyAmt, offerBuyGem));
    }

    function setBuyOffer(uint id, ERC20 offerSellGem, uint payAmt, ERC20 offerBuyGem, uint buyAmt)
        public
    {
    ...
    function buy(ERC20 takerPayGem, uint takerPayAmt, ERC20 takerBuyGem, uint actualBuyAmt)
        internal
    {
